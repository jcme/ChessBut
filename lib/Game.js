...
function Game(params) {
  ...
  var variantName = selectRandomVariant();
  var Variant = require("./variants/" + variantName);
  ...
  this.board = this.variant.afterBoardInitialization(this.board);
...
//return "OnlySeeYourOwnPieces.js";
}
...
Game.prototype.move = function(moveString) {
  ...
  switch (validMove.type) {
    ...
    case 'capture' :
      var capturedPiece = this.board[validMove.captureSquare];
      ...
      this.board = this.variant.afterCaptureMove(this.board, this.board[validMove.endSquare], capturedPiece,
                  validMove.startSquare, validMove.endSquare, validMove.captureSquare);
      break;
